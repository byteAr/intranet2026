            ...
            <div class="absolute bottom-0 right-0 flex items-center gap-1">
              @if (user()?.avatar) {
                <button (click)="deleteAvatar()" [disabled]="deletingAvatar()"
                  class="h-7 w-7 rounded-full border-2 border-white flex items-center justify-center shadow text-white disabled:opacity-50"
              ...
              <button (click)="fileInput.click()"
                class="h-7 w-7 rounded-full border-2 border-white flex items-center justify-center shadow text-white"
